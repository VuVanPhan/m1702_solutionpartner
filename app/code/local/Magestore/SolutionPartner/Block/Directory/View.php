<?php
class Magestore_SolutionPartner_Block_Directory_View extends Mage_Customer_Block_Account_Navigation
{
...
//            }
    ...
    public function getDirectoryListHtml()
    {
        return $this->getChildHtml('directory_list');
    }
