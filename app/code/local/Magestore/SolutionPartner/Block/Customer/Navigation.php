<?php
class Magestore_SolutionPartner_Block_Customer_Navigation extends Mage_Customer_Block_Account_Navigation
{
...
//         die('222');
        ...
        Mage::dispatchEvent('solutionpartner_customer_navigation_add_link',array(
            'block'		=> $this,
            'link'		=> $link,
        ));
    ...
    public function getLinks(){
        ...
        Mage::dispatchEvent('solutionpartner_customer_navigation_get_links',array(
            'block'		=> $this,
            'links_obj'	=> $links,
        ));
