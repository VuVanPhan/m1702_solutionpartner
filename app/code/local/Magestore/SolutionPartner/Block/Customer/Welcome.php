<?php
class Magestore_SolutionPartner_Block_Customer_Welcome extends Mage_Core_Block_Template
{
    public function getPageIdentifier(){
        $storeId = Mage::app()->getStore()->getId();
        return Mage::getStoreConfig('solutionpartner/general/landing_page', $storeId);
    }
