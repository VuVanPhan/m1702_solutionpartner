 ...
 */
class Magestore_SolutionPartner_Adminhtml_TransactionsController extends Mage_Adminhtml_Controller_Action
{
    /**
    ...
    {
        $this->loadLayout()
            ->_setActiveMenu('solutionpartner/transaction')
            ->_addBreadcrumb(
                Mage::helper('adminhtml')->__('Transactions Log'),
                Mage::helper('adminhtml')->__('Transactions Log')
            );
        $this->getLayout()->getBlock('head')->setTitle($this->__('Transactions Log'));
        return $this;
    }
